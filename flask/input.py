...
def login():
    ...
    if cardType == 'ppv':
        ...
        card = card.replace(' ', '_')
        website_url = requests.get(
            'https://en.wikipedia.org/wiki/UFC_on_ESPN:_' + card)
        print(card)
        card = card.replace('_', ' ')
    elif cardType == 'fightNight':
        card = card.replace(' ', '_')
        website_url = requests.get(
            'https://en.wikipedia.org/wiki/UFC_Fight_Night:_' + card)
        print(card)
        card = card.replace('_', ' ')
    html = website_url.content
...
def foo():
    ...
    firstFightStart = firstFightStartInput[:2] + ':' + \
        firstFightStartInput[2:4] + ':' + firstFightStartInput[4:6]

    firstFightEndInput = request.form['firstFightEnd']
    firstFightEnd = firstFightEndInput[:2] + ':' + \
        firstFightEndInput[2:4] + ':' + firstFightEndInput[4:6]

    secondFightStartInput = request.form['secondFightStart']
    secondFightStart = secondFightStartInput[:2] + ':' + \
        secondFightStartInput[2:4] + ':' + secondFightStartInput[4:6]

    secondFightEndInput = request.form['secondFightEnd']
    secondFightEnd = secondFightEndInput[:2] + ':' + \
        secondFightEndInput[2:4] + ':' + secondFightEndInput[4:6]

    thirdFightStartInput = request.form['thirdFightStart']
    thirdFightStart = thirdFightStartInput[:2] + ':' + \
        thirdFightStartInput[2:4] + ':' + thirdFightStartInput[4:6]

    thirdFightEndInput = request.form['thirdFightEnd']
    thirdFightEnd = thirdFightEndInput[:2] + ':' + \
        thirdFightEndInput[2:4] + ':' + thirdFightEndInput[4:6]

    fourthFightStartInput = request.form['fourthFightStart']
    fourthFightStart = fourthFightStartInput[:2] + ':' + \
        fourthFightStartInput[2:4] + ':' + fourthFightStartInput[4:6]

    fourthFightEndInput = request.form['fourthFightEnd']
    fourthFightEnd = fourthFightEndInput[:2] + ':' + \
        fourthFightEndInput[2:4] + ':' + fourthFightEndInput[4:6]

    fifthFightStartInput = request.form['fifthFightStart']
    fifthFightStart = fifthFightStartInput[:2] + ':' + \
        fifthFightStartInput[2:4] + ':' + fifthFightStartInput[4:6]

    fifthFightEndInput = request.form['fifthFightEnd']
    fifthFightEnd = fifthFightEndInput[:2] + ':' + \
        fifthFightEndInput[2:4] + ':' + fifthFightEndInput[4:6]
    ...
    if cardType == 'ppv':
        runMKV = subprocess.call(['mkvmerge', '-o', card + 'split.mkv', card + '.mkv', '--split', 'timestamps:' +
                                  ...
                                  ',' + thirdFightStart + ',' + thirdFightEnd +
                                  ',' + fourthFightStart + ',' + fourthFightEnd
...
# Defining Winners and losers from DataFrame
    ...
    # Defining Strings for file rename
        ...
        renameDestOne = 'UFC ' + cardTable + ' - ' + \
            fightOneWinner + ' vs ' + fightOneLoser + '.mkv'
        renameDestTwo = 'UFC ' + cardTable + ' - ' + \
            fightTwoWinner + ' vs ' + fightTwoLoser + '.mkv'
        renameDestThree = 'UFC ' + cardTable + ' - ' + \
            fightThreeWinner + ' vs ' + fightThreeLoser + '.mkv'
        renameDestFour = 'UFC ' + cardTable + ' - ' + \
            fightFourWinner + ' vs ' + fightFourLoser + '.mkv'
        renameDestFive = 'UFC ' + cardTable + ' - ' + \
            fightFiveWinner + ' vs ' + fightFiveLoser + '.mkv'
    ...
    # Renaming Files after split
        ...
        filerenamelist = [fileOneRename, fileTwoRename,
                          fileThreeRename, fileFourRename, fileFiveRename]

    elif cardType == 'espn':
        sixthFightStartInput = request.form['sixthFightStart']
        sixthFightStart = sixthFightStartInput[:2] + ':' + \
            sixthFightStartInput[2:4] + ':' + sixthFightStartInput[4:6]
        sixthFightEndInput = request.form['sixthFightEnd']
        sixthFightEnd = sixthFightEndInput[:2] + ':' + \
            sixthFightEndInput[2:4] + ':' + sixthFightEndInput[4:6]
        runMKV = subprocess.call(['mkvmerge', '-o', card + 'split.mkv', card + '.mkv', '--split', 'timestamps:' +
                                  firstFightStart + ',' + firstFightEnd + ',' + secondFightStart + ',' + secondFightEnd +
                                  ',' + thirdFightStart + ',' + thirdFightEnd +
                                  ',' + fourthFightStart + ',' + fourthFightEnd
    ...
    # Defining Strings for file rename
        ...
        renameDestOne = 'UFC on ESPN ' + cardTable + ' - ' + \
            fightOneWinner + ' vs ' + fightOneLoser + '.mkv'
        renameDestTwo = 'UFC on ESPN ' + cardTable + ' - ' + \
            fightTwoWinner + ' vs ' + fightTwoLoser + '.mkv'
        renameDestThree = 'UFC on ESPN ' + cardTable + ' - ' + \
            fightThreeWinner + ' vs ' + fightThreeLoser + '.mkv'
        renameDestFour = 'UFC on ESPN ' + cardTable + ' - ' + \
            fightFourWinner + ' vs ' + fightFourLoser + '.mkv'
        renameDestFive = 'UFC on ESPN ' + cardTable + ' - ' + \
            fightFiveWinner + ' vs ' + fightFiveLoser + '.mkv'
        renameDestSix = 'UFC on ESPN ' + cardTable + ' - ' + \
            fightSixWinner + ' vs ' + fightSixLoser + '.mkv'
    ...
    # Renaming Files after split
        ...
        filerenamelist = [fileOneRename, fileTwoRename, fileThreeRename,
                          fileFourRename, fileFiveRename, fileSixRename]
    ...
    # Defining Strings for file rename
        ...
        renameOriginFive = card+'split-010.mkv'
        renameOriginSix = card+'split-012.mkv'
        renameDestOne = 'UFC Fight Night ' + cardTable + ' - ' + \
            fightOneWinner + ' vs ' + fightOneLoser + '.mkv'
        renameDestTwo = 'UFC Fight Night ' + cardTable + ' - ' + \
            fightTwoWinner + ' vs ' + fightTwoLoser + '.mkv'
        renameDestThree = 'UFC Fight Night ' + cardTable + ' - ' + \
            fightThreeWinner + ' vs ' + fightThreeLoser + '.mkv'
        renameDestFour = 'UFC Fight Night ' + cardTable + ' - ' + \
            fightFourWinner + ' vs ' + fightFourLoser + '.mkv'
        renameDestFive = 'UFC Fight Night ' + cardTable + ' - ' + \
            fightFiveWinner + ' vs ' + fightFiveLoser + '.mkv'
        renameDestSix = 'UFC Fight Night ' + cardTable + ' - ' + \
            fightSixWinner + ' vs ' + fightSixLoser + '.mkv'
